...
prinComp <- princomp(~ ., data = trSet[, -53], newdata = valSet)
...
We attempted a umber of approaches to build the model, some were less successful, while others were process extensive without producing better results. Below are the two we chose with their respective resultes in Accuracy, Kappa and Error Rate:   
